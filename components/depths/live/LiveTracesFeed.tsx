...
export interface LiveTracesFeedProps extends BaseChartProps {
  ...
  statusFilter?: Array<'OK'|'ERROR'|'UNSET'|string>;
...
export function LiveTracesFeed({
  ...
  const filtered = React.useMemo(() => {
    ...
    return cur;
  }, [snapshot, minDurationMs, statusFilter]);
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Sheet>
                    <SheetTrigger asChild>
                      <Button size="sm" variant="ghost" onClick={() => setSelected(r)}>Open</Button>
                    </SheetTrigger>
                    <SheetContent side="right">
                      ...
                      <div className="mt-4 space-y-2">
                        ...
                        {r.attributes && (
                          <pre className="mt-3 rounded bg-neutral-100 dark:bg-neutral-800 p-2 text-xs overflow-auto">
